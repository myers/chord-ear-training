...
var _user$project$EarTraining$playSound = _elm_lang$core$Native_Platform.outgoingPort(
	'playSound',
	function (v) {
		return v;
	});
var _user$project$EarTraining$playChord = function (chordName) {
	var _p0 = chordName;
	if (_p0.ctor === 'Nothing') {
		return _elm_lang$core$Platform_Cmd$none;
	} else {
		return _user$project$EarTraining$playSound(
			A2(
				_elm_lang$core$Basics_ops['++'],
				'media/',
				A2(_elm_lang$core$Basics_ops['++'], _p0._0, '-Chord-ES-399-Piezo.mp3')));
	}
};
var _user$project$EarTraining$soundPlayed = _elm_lang$core$Native_Platform.incomingPort('soundPlayed', _elm_lang$core$Json_Decode$string);
var _user$project$EarTraining$Model = F3(
	function (a, b, c) {
		return {currentChord: a, chords: b, numberCorrect: c};
	});
var _user$project$EarTraining$SoundPlayed = function (a) {
	return {ctor: 'SoundPlayed', _0: a};
};
var _user$project$EarTraining$subscriptions = function (model) {
	return _user$project$EarTraining$soundPlayed(_user$project$EarTraining$SoundPlayed);
};
var _user$project$EarTraining$NewChord = function (a) {
	return {ctor: 'NewChord', _0: a};
};
var _user$project$EarTraining$pickNewChord = function (model) {
	return A2(
		_elm_lang$core$Random$generate,
		_user$project$EarTraining$NewChord,
		A2(
			_elm_community$random_extra$Random_Extra$filter,
			function (n) {
				return !_elm_lang$core$Native_Utils.eq(n, model.currentChord);
			},
			_elm_community$random_extra$Random_Extra$sample(model.chords)));
};
var _user$project$EarTraining$init = function () {
	var model = {
	...
	return {
		ctor: '_Tuple2',
		_0: model,
		_1: _user$project$EarTraining$pickNewChord(model)
	};
}();
var _user$project$EarTraining$update = F2(
	function (msg, model) {
		var _p1 = msg;
		switch (_p1.ctor) {
			case 'Answer':
				return _elm_lang$core$Native_Utils.eq(
					...
					_1: _user$project$EarTraining$playSound('media/correct.mp3')
				} : {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			case 'SoundPlayed':
				var _p2 = _p1._0;
				if (_p2 === 'media/correct.mp3') {
					return {
						ctor: '_Tuple2',
						_0: model,
						_1: _user$project$EarTraining$pickNewChord(model)
			...
			default:
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{currentChord: _p3}),
					_1: _user$project$EarTraining$playChord(_p3)
				};
		}
	});
var _user$project$EarTraining$Answer = function (a) {
	return {ctor: 'Answer', _0: a};
};
var _user$project$EarTraining$chordButton = function (chordName) {
	return A2(
		_elm_lang$html$Html$button,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Events$onClick(
				_user$project$EarTraining$Answer(chordName)),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text(chordName),
			_1: {ctor: '[]'}
		});
};
var _user$project$EarTraining$view = function (model) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('What chord is playing?'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Number Correct: '),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html$text(
								_elm_lang$core$Basics$toString(model.numberCorrect)),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html$text(' Out of 20'),
								_1: {ctor: '[]'}
							}
						}
					}),
				_1: {
					...
					_0: A2(
						_elm_lang$html$Html$div,
						{ctor: '[]'},
						A2(_elm_lang$core$List$map, _user$project$EarTraining$chordButton, model.chords)),
					_1: {ctor: '[]'}
				}
			}
		});
};
var _user$project$EarTraining$main = _elm_lang$html$Html$program(
	{init: _user$project$EarTraining$init, view: _user$project$EarTraining$view, update: _user$project$EarTraining$update, subscriptions: _user$project$EarTraining$subscriptions})();

var Elm = {};
Elm['EarTraining'] = Elm['EarTraining'] || {};
if (typeof _user$project$EarTraining$main !== 'undefined') {
    _user$project$EarTraining$main(Elm['EarTraining'], 'EarTraining', undefined);
}
